    ...
    try {
      ...
      await queryRunner.query(`
        CREATE TABLE IF NOT EXISTS \`customer_dues\` (
          ...
          \`status\` ENUM('PENDING','PARTIAL','PARTIALLY_PAID','PAID','OVERDUE','WRITTEN_OFF','CANCELLED') NOT NULL DEFAULT 'PENDING',
      ...
      // ─── FK Indexes ───────────────────────────────────────────────────────
      // MySQL does not auto-index FK columns. These cover every join path.
      const fkIndexes: [string, string, string][] = [
        ['user_roles',                         'idx_ur_role',              'role_id'],
        ['role_permissions',                   'idx_rp_permission',        'permission_id'],
        ['tax_rates',                          'idx_tr_tax_category',      'tax_category_id'],
        ['products',                           'idx_prod_base_uom',        'base_uom_id'],
        ['products',                           'idx_prod_secondary_uom',   'secondary_uom_id'],
        ['products',                           'idx_prod_tax_category',    'tax_category_id'],
        ['product_variant_attributes',         'idx_pva_attribute',        'attribute_id'],
        ['product_variant_attributes',         'idx_pva_attr_value',       'attribute_value_id'],
        ['inventory_stock',                    'idx_is_warehouse',         'warehouse_id'],
        ['inventory_stock',                    'idx_is_variant',           'variant_id'],
        ['price_list_items',                   'idx_pli_product',          'product_id'],
        ['price_list_items',                   'idx_pli_variant',          'variant_id'],
        ['price_list_items',                   'idx_pli_uom',              'uom_id'],
        ['customer_groups',                    'idx_cg_price_list',        'default_price_list_id'],
        ['customers',                          'idx_cust_group',           'customer_group_id'],
        ['customers',                          'idx_cust_price_list',      'price_list_id'],
        ['customers',                          'idx_cust_referred_by',     'referred_by'],
        ['supplier_products',                  'idx_supp_prod_product',    'product_id'],
        ['supplier_products',                  'idx_supp_prod_variant',    'variant_id'],
        ['supplier_products',                  'idx_supp_prod_uom',        'purchase_uom_id'],
        ['sales_orders',                       'idx_so_warehouse',         'warehouse_id'],
        ['sales_order_items',                  'idx_soi_product',          'product_id'],
        ['sales_order_items',                  'idx_soi_variant',          'variant_id'],
        ['sales_order_items',                  'idx_soi_uom',              'uom_id'],
        ['sales_order_items',                  'idx_soi_tax_cat',          'tax_category_id'],
        ['quotations',                         'idx_quot_warehouse',       'warehouse_id'],
        ['quotations',                         'idx_quot_sales_person',    'sales_person_id'],
        ['quotations',                         'idx_quot_created_by',      'created_by'],
        ['quotation_items',                    'idx_qi_product',           'product_id'],
        ['purchase_orders',                    'idx_po_warehouse',         'warehouse_id'],
        ['purchase_order_items',               'idx_poi_product',          'product_id'],
        ['purchase_order_items',               'idx_poi_variant',          'variant_id'],
        ['purchase_order_items',               'idx_poi_uom',              'uom_id'],
        ['purchase_order_items',               'idx_poi_tax_cat',          'tax_category_id'],
        ['journal_entries',                    'idx_je_fiscal_period',     'fiscal_period_id'],
        ['journal_entry_lines',                'idx_jel_cost_center',      'cost_center_id'],
        ['journal_entry_lines',                'idx_jel_tax_category',     'tax_category_id'],
        ['general_ledger',                     'idx_gl_fiscal_period',     'fiscal_period_id'],
        ['general_ledger',                     'idx_gl_je',                'journal_entry_id'],
        ['general_ledger',                     'idx_gl_jel',               'journal_entry_line_id'],
        ['budgets',                            'idx_bud_fiscal_year',      'fiscal_year_id'],
        ['budgets',                            'idx_bud_cost_center',      'cost_center_id'],
        ['budget_lines',                       'idx_bl_account',           'account_id'],
        ['budget_lines',                       'idx_bl_fiscal_period',     'fiscal_period_id'],
        ['bank_accounts',                      'idx_ba_gl_account',        'gl_account_id'],
        ['bank_transactions',                  'idx_bt_je',                'journal_entry_id'],
        ['bank_reconciliations',               'idx_br_bank_account',      'bank_account_id'],
        ['expenses',                           'idx_exp_account',          'expense_account_id'],
        ['expenses',                           'idx_exp_paid_from',        'paid_from_account_id'],
        ['expenses',                           'idx_exp_je',               'journal_entry_id'],
        ['order_payments',                     'idx_op_payment_method',    'payment_method_id'],
        ['sales_returns',                      'idx_sr_sales_order',       'sales_order_id'],
        ['sales_returns',                      'idx_sr_customer',          'customer_id'],
        ['sales_returns',                      'idx_sr_warehouse',         'warehouse_id'],
        ['sales_return_items',                 'idx_sri_product',          'product_id'],
        ['sales_return_items',                 'idx_sri_variant',          'variant_id'],
        ['sales_return_items',                 'idx_sri_uom',              'uom_id'],
        ['sales_return_items',                 'idx_sri_so_item',          'sales_order_item_id'],
        ['shopping_carts',                     'idx_sc_coupon',            'coupon_id'],
        ['shopping_cart_items',                'idx_sci_product',          'product_id'],
        ['shopping_cart_items',                'idx_sci_variant',          'variant_id'],
        ['wishlists',                          'idx_wl_product',           'product_id'],
        ['wishlists',                          'idx_wl_variant',           'variant_id'],
        ['customer_dues',                      'idx_cd_sales_order',       'sales_order_id'],
        ['customer_due_collections',           'idx_cdc_payment_method',   'payment_method_id'],
        ['customer_due_collections',           'idx_cdc_bank_account',     'bank_account_id'],
        ['customer_due_collections',           'idx_cdc_je',               'journal_entry_id'],
        ['customer_due_collection_allocations','idx_cdca_due',             'customer_due_id'],
        ['credit_notes',                       'idx_cn_customer',          'customer_id'],
        ['credit_notes',                       'idx_cn_sales_order',       'sales_order_id'],
        ['credit_notes',                       'idx_cn_sales_return',      'sales_return_id'],
        ['debit_notes',                        'idx_dn_supplier',          'supplier_id'],
        ['debit_notes',                        'idx_dn_purchase_order',    'purchase_order_id'],
        ['payment_reminders',                  'idx_pr_customer_due',      'customer_due_id'],
        ['supplier_dues',                      'idx_sd_purchase_order',    'purchase_order_id'],
        ['supplier_payments',                  'idx_sp_payment_method',    'payment_method_id'],
        ['supplier_payments',                  'idx_sp_bank_account',      'bank_account_id'],
        ['supplier_payment_allocations',       'idx_spa_supplier_due',     'supplier_due_id'],
        ['inventory_batches',                  'idx_ib_variant',           'variant_id'],
        ['inventory_batches',                  'idx_ib_supplier',          'supplier_id'],
        ['inventory_batches',                  'idx_ib_warehouse',         'warehouse_id'],
        ['inventory_batches',                  'idx_ib_po',                'purchase_order_id'],
        ['inventory_serial_numbers',           'idx_isn_variant',          'variant_id'],
        ['inventory_serial_numbers',           'idx_isn_batch',            'batch_id'],
        ['inventory_serial_numbers',           'idx_isn_warehouse',        'warehouse_id'],
        ['inventory_serial_numbers',           'idx_isn_location',         'location_id'],
        ['location_inventory',                 'idx_li_variant',           'variant_id'],
        ['location_inventory',                 'idx_li_warehouse',         'warehouse_id'],
        ['location_inventory',                 'idx_li_location',          'location_id'],
        ['location_inventory',                 'idx_li_batch',             'batch_id'],
        ['stock_adjustments',                  'idx_sadj_warehouse',       'warehouse_id'],
        ['stock_adjustment_items',             'idx_sai_product',          'product_id'],
        ['stock_adjustment_items',             'idx_sai_variant',          'variant_id'],
        ['stock_adjustment_items',             'idx_sai_location',         'location_id'],
        ['stock_adjustment_items',             'idx_sai_uom',              'uom_id'],
        ['stock_movements',                    'idx_sm_uom',               'uom_id'],
        ['warehouse_transfers',                'idx_wt_from_wh',           'from_warehouse_id'],
        ['warehouse_transfers',                'idx_wt_to_wh',             'to_warehouse_id'],
        ['warehouse_transfer_items',           'idx_wti_product',          'product_id'],
        ['warehouse_transfer_items',           'idx_wti_variant',          'variant_id'],
        ['warehouse_transfer_items',           'idx_wti_uom',              'uom_id'],
        ['goods_received_notes',               'idx_grn_po',               'purchase_order_id'],
        ['goods_received_notes',               'idx_grn_warehouse',        'warehouse_id'],
        ['grn_items',                          'idx_grni_product',         'product_id'],
        ['grn_items',                          'idx_grni_variant',         'variant_id'],
        ['grn_items',                          'idx_grni_location',        'location_id'],
        ['grn_items',                          'idx_grni_uom',             'uom_id'],
        ['purchase_returns',                   'idx_pret_warehouse',       'warehouse_id'],
        ['purchase_returns',                   'idx_pret_po',              'purchase_order_id'],
        ['purchase_returns',                   'idx_pret_grn',             'grn_id'],
        ['purchase_return_items',              'idx_preti_product',        'product_id'],
        ['purchase_return_items',              'idx_preti_variant',        'variant_id'],
        ['purchase_return_items',              'idx_preti_uom',            'uom_id'],
        ['stores',                             'idx_store_warehouse',      'warehouse_id'],
        ['stores',                             'idx_store_price_list',     'default_price_list_id'],
        ['pos_terminals',                      'idx_pt_store',             'store_id'],
        ['pos_sessions',                       'idx_ps_terminal',          'terminal_id'],
        ['pos_sessions',                       'idx_ps_user',              'user_id'],
        ['pos_transactions',                   'idx_ptx_store',            'store_id'],
        ['pos_transactions',                   'idx_ptx_terminal',         'terminal_id'],
        ['pos_transactions',                   'idx_ptx_customer',         'customer_id'],
        ['pos_transaction_items',              'idx_ptxi_product',         'product_id'],
        ['pos_transaction_items',              'idx_ptxi_variant',         'variant_id'],
        ['pos_transaction_items',              'idx_ptxi_uom',             'uom_id'],
        ['pos_transaction_payments',           'idx_ptxp_payment_method',  'payment_method_id'],
        ['cash_movements',                     'idx_cm_session',           'session_id'],
        ['cash_movements',                     'idx_cm_store',             'store_id'],
        ['workstations',                       'idx_ws_warehouse',         'warehouse_id'],
        ['bill_of_materials',                  'idx_bom_variant',          'variant_id'],
        ['bill_of_materials',                  'idx_bom_uom',              'uom_id'],
        ['bom_items',                          'idx_bomi_product',         'product_id'],
        ['bom_items',                          'idx_bomi_variant',         'variant_id'],
        ['bom_items',                          'idx_bomi_uom',             'uom_id'],
        ['bom_operations',                     'idx_bomo_workstation',     'workstation_id'],
        ['work_orders',                        'idx_wo_bom',               'bom_id'],
        ['work_orders',                        'idx_wo_warehouse',         'warehouse_id'],
        ['work_orders',                        'idx_wo_uom',               'uom_id'],
        ['work_order_items',                   'idx_woi_product',          'product_id'],
        ['work_order_items',                   'idx_woi_uom',              'uom_id'],
        ['work_order_operations',              'idx_woo_workstation',      'workstation_id'],
        ['material_issues',                    'idx_mi_work_order',        'work_order_id'],
        ['material_issues',                    'idx_mi_warehouse',         'warehouse_id'],
        ['material_issue_items',               'idx_mii_product',          'product_id'],
        ['material_issue_items',               'idx_mii_uom',              'uom_id'],
        ['production_outputs',                 'idx_pout_product',         'product_id'],
        ['production_outputs',                 'idx_pout_warehouse',       'warehouse_id'],
        ['production_outputs',                 'idx_pout_uom',             'uom_id'],
        ['quality_inspections',                'idx_qi_product',           'product_id'],
        ['quality_inspections',                'idx_qi_grn',               'grn_id'],
        ['quality_inspections',                'idx_qi_prod_output',       'production_output_id'],
        ['import_jobs',                        'idx_ij_template',          'template_id'],
        ['import_jobs',                        'idx_ij_file_upload',       'file_upload_id'],
        ['hr_departments',                     'idx_hrd_parent',           'parent_id'],
        ['hr_designations',                    'idx_hrdes_department',     'department_id'],
        ['hr_employees',                       'idx_hre_department',       'department_id'],
        ['hr_employees',                       'idx_hre_designation',      'designation_id'],
        ['hr_employees',                       'idx_hre_reporting_to',     'reporting_to_id'],
        ['hr_leave_requests',                  'idx_hrlr_employee',        'employee_id'],
        ['hr_leave_requests',                  'idx_hrlr_leave_type',      'leave_type_id'],
        ['hr_payroll_components',              'idx_hrpc_payroll',         'payroll_id'],
      ];
