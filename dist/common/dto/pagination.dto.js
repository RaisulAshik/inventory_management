...
class PaginationDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, default: 1, minimum: 1 }, limit: { required: false, type: () => Number, default: 20, minimum: 1, maximum: 100 }, sortBy: { required: false, type: () => String }, sortOrder: { required: false, type: () => Object, default: "ASC", enum: ['ASC', 'DESC', 'asc', 'desc'] }, search: { required: false, type: () => String } };
    }
}
