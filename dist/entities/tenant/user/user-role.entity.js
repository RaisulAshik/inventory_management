...
let UserRole = class UserRole {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, userId: { required: true, type: () => String }, roleId: { required: true, type: () => String }, assignedBy: { required: true, type: () => String }, assignedAt: { required: true, type: () => Date }, user: { required: true, type: () => require("./user.entity").User }, role: { required: true, type: () => require("../role/role.entity").Role } };
    }
};
