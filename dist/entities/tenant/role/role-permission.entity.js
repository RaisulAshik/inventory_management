...
let RolePermission = class RolePermission {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, roleId: { required: true, type: () => String }, permissionId: { required: true, type: () => String }, createdAt: { required: true, type: () => Date }, role: { required: true, type: () => require("./role.entity").Role }, permission: { required: true, type: () => require("./permission.entity").Permission } };
    }
};
