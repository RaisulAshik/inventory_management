...
__decorate([
    ...
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], CreateOrderItemDto.prototype, "uomId", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateOrderItemDto.prototype, "discountPercentage", void 0);
__decorate([
...
class AddressDto {
    ...
    postalCode;
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String }, phone: { required: false, type: () => String }, addressLine1: { required: false, type: () => String }, addressLine2: { required: false, type: () => String }, city: { required: false, type: () => String }, state: { required: false, type: () => String }, country: { required: false, type: () => String }, postalCode: { required: false, type: () => String } };
    }
}
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
...
class CreateOrderDto {
    ...
    items;
    static _OPENAPI_METADATA_FACTORY() {
        return { customerId: { required: true, type: () => String, format: "uuid" }, warehouseId: { required: true, type: () => String, format: "uuid" }, billingAddress: { required: false, type: () => AddressDto }, shippingAddress: { required: false, type: () => AddressDto }, orderDate: { required: false, type: () => Date }, expectedDeliveryDate: { required: false, type: () => Date }, currency: { required: false, type: () => String }, exchangeRate: { required: false, type: () => Number }, discountPercentage: { required: false, type: () => Number, minimum: 0 }, discountAmount: { required: false, type: () => Number, minimum: 0 }, shippingAmount: { required: false, type: () => Number, minimum: 0 }, notes: { required: false, type: () => String }, internalNotes: { required: false, type: () => String }, items: { required: true, type: () => [CreateOrderItemDto] } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateOrderDto.prototype, "discountPercentage", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 0 }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
...
__decorate([
    ...
    (0, class_validator_1.Min)(0),
    __metadata("design:type", Number)
], CreateOrderDto.prototype, "shippingAmount", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
