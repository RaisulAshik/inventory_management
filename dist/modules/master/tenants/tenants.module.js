...
exports.TenantsModule = TenantsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([tenant_entity_1.Tenant, tenant_database_entity_1.TenantDatabase, master_1.TenantBillingInfo, tenant_user_entity_1.TenantUser, subscription_entity_1.Subscription], 'master'),
        ],
